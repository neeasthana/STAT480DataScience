...
count <- table(locdata00$city) 
delaycount <- table(locdata00[locdata00$ArrDelay > 0, "city"]) # delay count for each city
...
The delay rate for each city was highly different.
...
DTsum <- aggregate(ArrDelay ~ city, locdata00[locdata00$ArrDelay > 0,], sum)
