...
count <- table(locdata$state) 
delaycount <- table(locdata[locdata$ArrDelay > 0, "state"]) # delay count for each city
...
DTsum <- aggregate(ArrDelay ~ state, locdata[locdata$ArrDelay > 0,], sum)
...
#### circle_diagrams for states , top 50 Arrdelay
