...
count <- table(locdata99$city) 
delaycount <- table(locdata99[locdata99$ArrDelay > 0, "city"]) # delay count for each city
...
DTsum <- aggregate(ArrDelay ~ city, locdata99[locdata99$ArrDelay > 0,], sum)
